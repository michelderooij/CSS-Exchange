...
.DESCRIPTION
	...
	2013/2016/2019.  The script will run against Exchange 2010/2007 but the output is more limited.
.PARAMETER Server
...
.PARAMETER LoadBalancingReport
    ...
    running Exchange 2013/2016/2019 with the Client Access role in the org.  It then breaks down servers by percentage to
...
.PARAMETER CasServerList
    ...
    this switch the report will use all 2013/2016/2019 Client Access servers in the organization.
.PARAMETER SiteName
...
.EXAMPLE
    ...
    Run against all Exchange 2013/2016/2019 servers in the Organization.
.EXAMPLE
    .\HealthChecker.ps1 -LoadBalancingReport
    Run a load balancing report comparing all Exchange 2013/2016/2019 CAS servers in the Organization.
.EXAMPLE
